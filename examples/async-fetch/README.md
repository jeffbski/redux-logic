...
## Files of interest
 ...
 - `src/users/actions.js` - contains the action creators created with redux-actions

 - `src/users/reducer.js` - contains a reducer which handles all the users specific state. Created using redux-actions. Also contains the users related selectors. By collocating the reducer and the selectors we only have to update this one file to change the shape of our reducer state.
