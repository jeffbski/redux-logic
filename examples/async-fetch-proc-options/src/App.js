  ...
  return (
      <div className="App">
        <div className="App-header">
          ...
          <h2>Async Fetch Process Options</h2>
        </div>
        <div className="usersDiv">
          <div className="desc">
      <p>Demonstrates the use of redux-logic to perform async fetching using the new processOptions feature. This example uses the built-in declarative functionality for cancellation and limiting (takeLatest).
      </p>
