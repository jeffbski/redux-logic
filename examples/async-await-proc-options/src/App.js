  ...
  return (
      <div className="App">
        <div className="App-header">
          ...
          <h2>Async Await - Async Functions using processOptions</h2>
        </div>
        <div className="container">
          <div className="desc">
            <p>Demonstrates the use of redux-logic to perform async fetching using async functions (async await). This example uses the built-in declarative functionality for cancellation and limiting (takeLatest). It is also using processOptions which cleans up the code considerably.
            </p>
