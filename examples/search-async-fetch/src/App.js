  ...
  return (
      <div className="App">
        <div className="App-header">
          ...
          <h2>Search Async Fetch</h2>
        </div>
        <div className="usersDiv">
          <div className="desc">
            <p>Demonstrates the use of redux-logic to perform automatic async search as the input changes. This example uses the built-in declarative functionality for debouncing and limiting (takeLatest).
            </p>
